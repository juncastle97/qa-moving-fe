...
export default function WaitingQuote({ quoteStatuses, data }) {
  ...
  const handleCardClick = (id) => {
    router.push(`/my-quote/wait/${id}`);
  };

  return (
    <div className="flex h-354 w-688 flex-col gap-24 rounded-16 bg-white px-14 py-16 shadow-custom">
      ...
      <div className="flex justify-center gap-12">
        ...
        <button
          ...
          className="h-64 w-314 rounded-16 border border-primary-blue-300 bg-white p-16 text-xl-20px-semibold text-primary-blue-300 hover:border-primary-blue-200 hover:text-primary-blue-200"
        >
          상세보기
        </button>
      </div>
