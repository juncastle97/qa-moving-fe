...
const RejectQuoteModal = ({ onClose, data, quoteStatuses }) => {
  ...
  const isButtonDisabled = review.length < 10;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="w-608 rounded-32 bg-white px-24 pb-40 pt-32">
        <div className="flex h-36 items-center justify-between p-4">
          <p className="text-2xl-24px-semibold">반려 요청</p>
        ...
        <div className="p-4">
          <div className="my-40">
            ...
            <div className="flex flex-col gap-32">
              <div>
                <p className="mt-32 mb-16 text-xl-20px-semibold text-black-300">반려 사유를 입력해 주세요</p>
                <textarea
