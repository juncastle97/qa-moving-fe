...
import reviewData from "@/mock/review/myReview";
import MyReviews from "@/components/Card/MyReviews";
...
export default function MyReview() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center min-h-screen bg-bg-200 px-260 pt-40">
        <div className="grid min-h-[1130px] w-1360 grid-cols-2 gap-x-24 gap-y-48">
          {currentReviews.map((data, index) => (
            <MyReviews key={index} quoteStatuses={data.quoteStatuses} data={data} />
          ))}
        </div>
